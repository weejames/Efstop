...
$.fn.autocomplete =
  function(options){ return this.each(function(){
	...
	for (var i=0;i<arr.length;i++){
			...
			if (arr[i].style != undefined && arr[i].style != "") var span = $('<span class="jqac-link"><span class="thumb" style="'+arr[i].style+'"></span></span>').get(0);
            else var span = $('<span class="jqac-link">'+output+'</span>').get(0);
